...
import com.avi.police.AreaActivity.DBAsyncTask;
...
public class AreaActivity extends ListActivity implements SearchView.OnQueryTextListener {
	...
	ListView list;
	int count = 0,flag = 0;
	String extra =  "com.avi.police.EXTRA" ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		extra = intent.getStringExtra(CriminalActivity.DETAIL);
		 
		 setListAdapter(new ArrayAdapter<String>(AreaActivity.this,android. R.layout.simple_list_item_1, detailsLIst));
	...
	public boolean onQueryTextChange(String newText) {
		...
		if(count>0)
		{
			...
			setListAdapter(new ArrayAdapter<String>(AreaActivity.this,android. R.layout.simple_list_item_1,refinedList));
	...
	class DBAsyncTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			try{
				...
				httppost = new HttpPost("http://testandroid.net46.net/getCriminalByArea.php");
				ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();           
				   nameValuePairs.add(new BasicNameValuePair("area",params[0]));
			...
			try{
				...
				for(int i=0; i<jArray.length();i++){
					JSONObject json = jArray.getJSONObject(i);
							 ...
							 detailsLIst[i] =  json.getString("NAME");
