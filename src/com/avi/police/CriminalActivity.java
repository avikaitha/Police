...
import com.avi.police.CriminalActivity.DBAsyncTask;
...
public class CriminalActivity extends ListActivity implements SearchView.OnQueryTextListener{
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent intent = new Intent(CriminalActivity.this,AreaActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		list = (ListView) findViewById(android.R.id.list);
		 ...
		 setListAdapter(new ArrayAdapter<String>(CriminalActivity.this,android. R.layout.simple_list_item_1, detailsLIst));
	...
	public boolean onQueryTextChange(String newText) {
		...
		if(count>0)
		{
			...
			setListAdapter(new ArrayAdapter<String>(CriminalActivity.this,android. R.layout.simple_list_item_1,refinedList));
	...
	class DBAsyncTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			try{
				...
				httppost = new HttpPost("http://testandroid.net46.net/getCriminalDetails.php");
			...
			try{
				...
				for(int i=0; i<jArray.length();i++){
					JSONObject json = jArray.getJSONObject(i);
							 ...
							 detailsLIst[i] =  json.getString("AREA");
